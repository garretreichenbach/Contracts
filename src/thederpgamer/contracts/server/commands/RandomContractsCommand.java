...
public class RandomContractsCommand implements CommandInterface {
    ...
    public String getDescription() {
        return "Creates a randomly generated contract and adds it to the contracts list. If an amount is specified, generates multiple random contracts.\n" +
               "- /%COMMAND% [amount] : Generates multiple random contracts, or just a single one if no amount is specified.";
    }
